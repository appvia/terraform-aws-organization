...
| <a name="input_enable_guardduty"></a> [enable\_guardduty](#input\_enable\_guardduty) | A boolean flag to enable GuardDuty within the management account. | `bool` | `true` | no |
